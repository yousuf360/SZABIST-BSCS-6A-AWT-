...
<c:forEach var="student" items="${students}">
	<tr>
		...
		<td><a href="/SpringHiber1/edit?regno=${ student.regno }" id=${ student.regno }>
					...
					<c:forEach var="sec" items="${sections }">
						...
						<c:choose>
							<c:when test="${hSchedule.containsKey(key) }">
								...
								<td id="cls" day="${schedules[0].getId().dayid }" slot="${schedules[0].getId().subslotid }" sectionname="${schedules[0].getId().sectionname }" ">
